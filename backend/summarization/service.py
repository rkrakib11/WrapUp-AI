    ...
    def _build_summary_messages(
        *,
        ...
        prompt = (
            ...
            "LENGTH IS DRIVEN BY CONTENT, NOT BY TRANSCRIPT SIZE. Read the transcript and "
            "judge how much substantive content is actually present, then write a summary that "
            "honestly reflects that. Apply these rules:\n"
            "- executive_summary must faithfully cover the topic, key arguments, and outcomes "
            "of what was actually said. Do NOT pad. Do NOT trim genuine substance for the sake "
            "of brevity.\n"
            "- If the transcript is very short (a few sentences) and covers a single idea, a "
            "1–2 sentence executive_summary is correct.\n"
            "- If the speakers ramble, repeat themselves, go off-topic, or fill time without "
            "substance, keep executive_summary short (2–4 sentences) even when the transcript "
            "is long. Length must reflect substance, not word count.\n"
            "- If the transcript is substantive — multiple distinct topics, developed "
            "arguments, decisions, or detailed discussion — write a proportionally longer "
            "executive_summary that captures all of it. As calibration only (not quotas): a "
            "focused 1,000-word substantive transcript typically warrants ~80–100 words; "
            "1,500 substantive words ~100–150 words; a 7-minute IELTS-style developed answer "
            "~120–180 words. Use these as guides, write what the content actually deserves.\n"
            "- Never produce a one-line executive_summary unless the transcript itself "
            "contains only one line of real content.\n"
            "- key_points: include as many as the transcript genuinely contains. A 30-second "
            "clip may have 1–2; a substantive 10-minute discussion may have 8–12. Do not "
            "invent points to fill a quota; do not omit real points to stay short.\n"
            "- decisions, follow_ups, action_items: include all that actually appear; do not "
            "trim for brevity. Omit fields entirely if the transcript contains none.\n"
            "- Be specific. Use concrete details from the transcript over generic phrasing."
        )
        return [
            {
                "role": "system",
